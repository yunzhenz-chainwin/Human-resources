...
.criteria-grid label,.hard-gates label{font-size:13px}.criteria-grid input{font-size:14px}.criteria-grid small{font-size:12px;line-height:1.5}
...
.pending-message b{font-size:15px}.pending-message span{font-size:13px}.feedback{font-size:13px;line-height:1.55}
